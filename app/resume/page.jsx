...
const Resume = () => {
    return (
        ...
        className="min-h-[80vh] flex items-center justify-center py-12 xl:py-0 px-4"
        >
            <div className="container max-w-screen-xl mx-auto">
                <Tabs defaultValue="experince" className="flex flex-col xl:flex-row gap-10 xl:gap-[60px]">
                            ...
                            <div className="flex flex-col gap-[30px] text-center xl:text-left">
                                ...
                                <ScrollArea className="h-[400px] overflow-y-auto">
                                    <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
                                        ...
                                        <li key={index} className="bg-[#232329] h-auto py-8 px-6 rounded-lg flex flex-col justify-center items-center lg:items-start gap-2">
                                            <span className="text-accent text-sm lg:text-base">{item.duration}</span>
                                            <h3 className="text-lg lg:text-xl font-semibold text-center lg:text-left">{item.position}</h3>
                            ...
                            <div className="flex flex-col gap-[30px] text-center xl:text-left">
                                ...
                                <ScrollArea className="h-[400px]">
                                    <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
                                        ...
                                        <li key={index} className="bg-[#232329] h-auto py-8 px-6 rounded-lg flex flex-col justify-center items-center lg:items-start gap-2">
                                            <span className="text-accent text-sm lg:text-base">{item.duration}</span>
                                            <h3 className="text-lg lg:text-xl font-semibold text-center lg:text-left">{item.institution}</h3>
                                            <div className="flex items-center gap-2">
                                                <span className="w-[8px] h-[8px] rounded-full bg-accent"></span>
                                        ...
                                        <li key={index}>
                                            <TooltipProvider delayDuration={100}>
                                                <Tooltip>
                                                    ...
                                                    <TooltipContent className="capitalize">{skill.title}</TooltipContent>
                                                </Tooltip>
                                            </TooltipProvider>
                                        </li>
                                    ))}
                                ...
                                <ul className="grid grid-cols-1 xl:grid-cols-2 gap-y-6">
                                    {about.info.map((item, index) => (
                                        <li key={index} className="text-white/60">
                                            <span className="text-accent font-medium">{item.fieldName}:</span> {item.fieldValue}
                                        </li>
                                    ))}
                                </ul>
                            </div>
